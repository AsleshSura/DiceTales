...
3. **Read the opening narrative** generated by HuggingFace AI
4. **Choose your action** from the provided options
5. **Roll dice strategically** - remember, only **one roll per turn**!
6. **Watch your story unfold** based on your choices and rolls

### Turn-Based Strategy (New in v2.0)
- **Strategic rolling**: You can only roll dice **once per turn**
- **Turn progression**: Each choice or dice roll advances the story
- **Visual feedback**: Dice availability is clearly shown
- **Planning required**: Think carefully before rolling!
